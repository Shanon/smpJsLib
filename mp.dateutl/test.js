(function() {
  ...
  module('getMonthStartDate, getMonthEndDate', {
    setup: function() {
      this.dateString = '';
      this.base_string = '2013-01-16';
      this.base_date = mpdateutl.date(this.base_string);
    }
  });

  test('getMonthStartDate', function() {
    var string_to_date = mpdateutl.getMonthStartDate(this.base_string)
    , date_to_date = mpdateutl.getMonthStartDate(this.base_date);

    strictEqual(mpdateutl.toMpString(string_to_date), '2013-01-01', 'string');
    strictEqual(mpdateutl.toMpString(date_to_date), '2013-01-01', 'string');
  });

  test('getMonthStartDate', function() {
    var string_to_date = mpdateutl.getMonthEndDate(this.base_string)
    , date_to_date = mpdateutl.getMonthEndDate(this.base_date);

    strictEqual(mpdateutl.toMpString(string_to_date), '2013-01-31', 'string');
    strictEqual(mpdateutl.toMpString(date_to_date), '2013-01-31', 'string');
  });
}());
